...
const d2 = await readDict(pathTo("lang-en/dictionary-en-classic.csv"));
const d3 = await readDict(pathTo("lang-en/dictionary-en-news.csv"));
const d4 = await readDict(pathTo("lang-en/dictionary-en-wiki.csv"));
